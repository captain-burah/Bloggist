      ...
      <div class="col-md-5 ml-auto mr-auto ">
        <div class="py-4 my-1">
          ...
          <div class="text-right">
            ...
            <h4 class="text-dark"> <a href="javascript:void(0)" onclick="scrollLecReg()" class="text-dark">{{ __('or you can go register now') }}</a></h4>
        </div>
        </div>
      </div>
          ...
          <!---------------------- SignUp Body -------------------------------->
            <div class="card-body">
              ...
              aria-label="{{ __('Register') }}" name="tutorForm">
                  ...
                  <div class="form-group p-0">
                      <input type="checkbox" name="privacyPolicy"/> {{_("I have read & agreed to the ")}} 
