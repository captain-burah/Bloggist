            ...
            <div class="intro mb-3">
                <div class="row justify-content-center align-items-center">
                    <div class="col-md-6 shadow">
                        <h2 class="text-primary headblast">Lesson Overview</h2>
                        <p>
                        ...
                        <div class="mt-3 mb-2"> 
                            <router-link to="/Lessons/Syllabus" class="text-dark">
                                <button type="button" class="btn btn-primary btn btn-block border-dark">
                                <i class="fas fa-arrow-right"></i>
                                    &nbsp;
                                        First display a Syllabus here
                                </button>
                            </router-link>
                        </div>
                    </div>
          ...
          <div class="col-md-12">
            <div class="card text-dark bg-transparent border border-secondary mt-3">
              <div class="card-header bg-dark ">
                <h3 class="card-title text-light">List of Lessons</h3>
            ...
            <div class="modal-dialog modal-dialog-centered">
                ...
                <!------ Modal: Button ----------------------------------------------------->
                    <div class="modal-header">
                        <h5 class="modal-title text-dark" id="createPaperLabel">Create New Lesson</h5>
...
*/
            ...
            createPapers(){
                ...
                .then(()=>{
                    ...
                    window.location.href = '/CreateLessons';
